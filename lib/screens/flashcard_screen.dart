...
import 'package:burmese_quiz_in_flutter/screens/quiz_screen.dart';
import 'package:burmese_quiz_in_flutter/widgets/flashcard_widget.dart';
import 'package:burmese_quiz_in_flutter/widgets/linear_progress_indicator_widget.dart';
...
class _NewCardState extends State<NewCard> {
  ...
  Widget build(BuildContext context) {
    const Color bgColor3 = Color.fromARGB(255, 34, 174, 234);
    const Color cardColor = Color.fromARGB(247, 10, 21, 231);
