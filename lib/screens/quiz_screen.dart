...
import 'package:burmese_quiz_in_flutter/screens/results_screen.dart';
...
class _QuizScreenState extends State<QuizScreen> {
  ...
  Widget build(BuildContext context) {
    const Color bgColor3 = Color.fromARGB(255, 29, 201, 231);
    const Color bgColor = Color.fromARGB(255, 133, 140, 9);
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    Text(
                      "${widget.topicType} Riddles in Flutter!",
  ...
  ElevatedButton buildElevatedButton() {
    ...
    const Color cardColor = Color.fromARGB(255, 185, 216, 5);
