import 'package:burmese_quiz_in_flutter/models/topics_model.dart';
import 'package:burmese_quiz_in_flutter/screens/flashcard_screen.dart';
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const Color bgColor = Color.fromARGB(235, 231, 162, 184);
    const Color bgColor3 = Color.fromARGB(255, 9, 152, 218);
    return Scaffold(
